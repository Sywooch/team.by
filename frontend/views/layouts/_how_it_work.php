		...
		<div class="row clearfix">
			...
			<div class="col-lg-4">
				<div class="how_it_work__2_cnt">
					...
					<p class="how_it_work__txt">Выберите профессионала и отправьте нам <a href="#" id="zayavka-one-click" data-review="<?= \Yii::$app->urlManager->createUrl(['site/zakaz-spec1']) ?>">заявку одним кликом</a> или<br>телефонным звонком  <span class="how_it_work__phone">722-11-44</span> <span class="ico-velcom dib"> </span> <span class="ico-mts dib"> </span> <span class="ico-life dib pos-abs" style="margin:3px 0 0 5px;"> </span></p>
				</div>
			</div>
			<div class="col-lg-4">

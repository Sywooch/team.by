		...
		<div class="profile_anketa_row row clearfix">
			<div class="col-lg-6">
				<div id="uploading-avatar" class="form-group clearfix">
					<div class="row clearfix">
						...
						<div class="col-lg-5">
							<span id="avatar-cnt">
								<?php if($model->avatar) echo Html::a(Html::img(Url::home(true) . Yii::$app->params['avatars-path'] . '/thumb_' .$model->avatar, ['class'=>'img-responsive']), Url::home(true) . Yii::$app->params['avatars-path'] . '/' .$model->avatar, ['class' => '', 'data-toggle' => 'lightbox']) ?>
							</span>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-6">
				<div id="uploading-price" class="form-group row clearfix">
					...
					<div class="col-lg-8">
						<?= Html::a($model->price_list, Url::home(true).Yii::$app->params['pricelists-path'].'/'.$model->price_list)?>
					</div>
